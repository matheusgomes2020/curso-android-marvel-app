...
class DetailParentAdapter(
    ...
    class DetailParentViewHolder(
        ...
        fun bind(detailDetailParentVE: DetailParentVE) {
            textItemCategory.text = itemView.context.getString(detailDetailParentVE.categoryStringResId)
            recyclerChildDetail.run {
                setHasFixedSize(true)
                adapter= DetailChildAdapter(detailDetailParentVE.detailChielList, imageLoader)
            }
        }
